...
// Conecta ao broker MQTT na porta 1883
const client = mqtt.connect('ws://localhost:9001');

client.on('connect', () => {
  console.log('Conectado ao broker MQTT!');
  client.subscribe('topico/teste', (err) => {
    if (!err) {
      console.log('Inscrito no tópico topico/teste');
    }
  });
});
        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <Grid container spacing={2} justifyContent="center">
              ...
              <Grid item>
                <Button variant="contained" color="primary" onClick={() => publishMessage('LZD1')}>LZD1</Button>
              </Grid>
              <Grid item>
                <Button variant="contained" color="primary" onClick={() => publishMessage('LZD1')}>LZD1</Button>
              </Grid>
